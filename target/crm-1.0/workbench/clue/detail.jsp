...
<script type="text/javascript">
	...
	function showActivityList() {
		$.ajax({
			url:"workbench/clue/getAvtivityByClueId.do",
			data:{
				"clueId":"${c.id}"
			},
			type:"get",
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html +='<td>'+n.owner+'</td>'
					html +='<td><a href="javascript:void(0);" onclick="unrelation(\''+n.id+'\')" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
					html +='</tr>'
				})
				$("#tbody").html(html)
			}
	...
	function unrelation(id) {
		alert(id)
		$.ajax({
			url:"workbench/clue/unrelation.do",
			data:{
				"id":id
			},
			type:"post",
